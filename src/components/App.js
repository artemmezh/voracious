          ...
          <Switch>
            <Route path="/player/:cloc/:vid" render={({ match, history }) => {
              ...
              return <Player
                  ...
                  onUpdatePlaybackPosition={(pos) => { actions.saveVideoPlaybackPosition(collectionLocator, videoId, pos); }}
                  onNeedSubtitles={() => { actions.loadSubtitlesIfNeeded(collectionLocator, videoId); }}
                  getSavedPlaybackPosition={() => { return actions.loadVideoPlaybackPosition(collectionLocator, videoId); }}
                  onSetPreference={(pref, value) => { actions.setPreference(pref, value); }}
                  ...
                  subtitleInfo={ actions.getSubtitleInfo(collectionLocator, videoId) }
